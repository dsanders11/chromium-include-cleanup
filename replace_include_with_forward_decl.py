...
def minimize_includer_header(code: str) -> str:
    """Minimize the includer header by stripping out comments, checks, forward declarations, etc."""
...
def replace_include_with_forward_decl(
    ...
    source_content = minimize_includer_header(get_file_content(revision, source))
